<%-- Document : footer.jsp Created on : Feb 10, 2025, 1:07:16 AM Author : OS
...
<html>
  ...
  <style>
    .footer {
        background-color: ${content.footerBackgroundColor} !important;
        color: ${content.footerTextColor} !important;
    }
    .footer a, .footer h3 {
        color: ${content.footerTextColor} !important;
    }
