    ...
    <header class="header-container">
          ...
          <div class="dropdown">
            ...
            <div id="myDropdown" class="dropdown-content">
              ...
              <c:if test="${user.role.userRole == 'Customer'}">
                ...
                <a href="${contextPath}/manager/order-list"
                  >Orders Management</a
                >
              </c:if>
              ...
              <c:if test="${user.role.userRole == 'Manager'}">
                ...
                <a href="${contextPath}/manager/product-management"
              ...
              <c:if
                test="${user.role.userRole == 'Seller' ||
      ...
      <nav class="header-nav">
        <ul>
          ...
          <li>
            <a href="${contextPath}/MenuController?service=allProduct&name=1"
              >Gấu bông</a
            >
          </li>
          <li>
            <a href="${contextPath}/MenuController?service=allProduct&name=2"
              >Móc khóa</a
            >
          </li>
          <li>
            <a href="${contextPath}/MenuController?service=allProduct&name=3"
              >Gối Ôm</a
            >
          </li>
          <li>
            <a href="${contextPath}/MenuController?service=allProduct"
              >Tất cả SP</a
            >
          </li>
        </ul>
