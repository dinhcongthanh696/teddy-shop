...
<html>
    ...
    <body style="margin-top: 80px">
        <jsp:include page="${contextPath}/gui/header.jsp"></jsp:include>
            ...
            <c:if test="${not empty sessionScope.CategoryNotification}">
                <div class="alert alert-success alert-dismissible fade show" role="alert" style="text-align: center">
                    ${sessionScope.CategoryNotification}
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
                <%
                    session.removeAttribute("CategoryNotification");
                %>
            </c:if>
                    ...
                    <c:forEach var="product" items="${products}" varStatus="status">
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="edit-product?id=${product.id}" class="btn btn-warning btn-sm">✏️</a>
